...
public class QuizController : ControllerBase
{
    ...
    public QuizController(IQueryHandler<GetQuizzesQuery, List<QuizDetailsDto>> getQuizzesHandler,
        IQueryHandler<GetQuizByIdQuery, QuizDetailsDto> getQuizByIdHandler,
        ICommandHandler<AddQuizCommand> addQuizHandler, ICommandHandler<RemoveQuizCommand> removeQuizHandler,
        ICommandHandler<UpdateQuizCommand> updateQuizHandler)
    {
